...
public static class IdentityApiEndpointRouteBuilderExtensions
{
        ...
        where TUser : User, new()
    {
        ...
        routeGroup.MapPost("/login", async Task<Results<Ok<AccessTokenResponse>, ProblemHttpResult>> (
            ...
            var claims = new List<Claim>
    {
        ...
        new Claim(JwtRegisteredClaimNames.Jti, Guid.NewGuid().ToString())
            ...
            var expires = DateTime.UtcNow.AddMinutes(Convert.ToDouble(config["Jwt:ExpireMinutes"] ?? "60"));
            ...
            return TypedResults.Ok(new AccessTokenResponse
            {
                ...
                ExpiresIn = (int)TimeSpan.FromMinutes(Convert.ToDouble(config["Jwt:ExpireMinutes"] ?? "60")).TotalSeconds,
